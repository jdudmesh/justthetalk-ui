...
export default function Home(props) {
    ...
    const renderSubscriptions = () => {
        ...
        return <>
            ...
            { unreadsubs.length === 0
                ? <Alert severity="info" className={styles.userAlert} action={<Button color="primary" size="small" onClick={onSetClickToViewAllSubs}>Click to {`${showReadSubs ? "hide" : "show"}`} all subscriptions</Button>}>You're up to date with all your subscriptions</Alert>
